...
def read_pdf_file():
    pdfdoc = filedialog.askopenfilename(initialdir='', title="Select file", filetypes=(
...
b1 = Button(root, text="Text to Speech", padx=5, pady=5,
            bg='white', fg='green', command=read_text)
b1.pack()

b2 = Button(root, text="Read Text/Word File", padx=5, pady=5,
            bg='white', fg='green', command=read_text_fille)
b2.pack()

b3 = Button(root, text="Read PDF File", padx=5, pady=5,
            bg='white', fg='green', command=read_pdf_file)
b3.pack()
